...
function actor:init()
    ...
    if Kristal.getLibConfig("magical-glass-deltatraveled", "susie_style") == "inaccurate" then
        self.animations["lightbattle/idle"] = {"battle/idle_sleep_deprived", 1, false}
        self.lw_battle_offset_up = {0, 7}
    end
