...
DefendingActionBox          = libRequire("magical-glass", "scripts/lightbattle/ui/defendingactionbox")
DefendingActionBoxDisplay   = libRequire("magical-glass", "scripts/lightbattle/ui/defendingactionboxdisplay")
