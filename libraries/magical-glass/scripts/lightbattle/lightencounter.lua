...
function LightEncounter:onSoulTransition()
    ...
    Game.battle.timer:script(function(wait)
        ...
        if self.story then
            ...
            Game.battle.soul:slideTo(49, 455, 17/30) -- BUG: X value is static, it needs to be accurate to the first button location when using less than 4 buttons. Couldn't find how to check for the amount of buttons the battler has.
        end
